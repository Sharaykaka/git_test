...
build_time_vars = {'ABIFLAGS': '',
 ...
 'CONFIG_ARGS': "'--prefix=/run/media/owais/DATA_OWAIS/iNeuron_Git/venv' "
                ...
                "-I/run/media/owais/DATA_OWAIS/iNeuron_Git/venv/include' "
                "'CPP=/run/media/owais/DATA_OWAIS/iNeuron_Git/venv/bin/powerpc64le-conda_cos7-linux-gnu-cpp' "
 ...
 'LIBPL': '/run/media/owais/DATA_OWAIS/iNeuron_Git/venv/lib/python3.8/config-3.8-powerpc64le-linux-gnu',
